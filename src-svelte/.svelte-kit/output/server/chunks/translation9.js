const About = "Informazioni";
const Action = "Azione";
const Add = "Aggiungi";
const advanced = "Avanzate";
const Advanced = "Avanzato";
const All = "Tutti";
const Arguments = "Argomenti";
const assistant = "Assistente";
const Auto = "Automatico";
const cancel = "Annulla";
const Cancel = "Annulla";
const Capabilities = "Capacità";
const Changelog = "Registro modifiche";
const characters = "caratteri";
const chat = "Chat";
const Chat = "Chat";
const Check = "Controlla";
const Chunk = "Blocco";
const chunks = "blocchi";
const clean = "Pulisci";
const close = "Chiudi";
const Close = "Chiudi";
const Collapse = "Comprimi";
const Command = "Comando";
const Completed = "Completato";
const Confirm = "Conferma";
const Connected = "Connesso";
...
const Cost = "Costo";
const Create = "Crea";
const creative = "Creativo";
const Custom = "Personalizzato";
const Deactivate = "Disattiva";
const Delete = "Elimina";
const Description = "Descrizione";
const Details = "Dettagli";
const Disabled = "Disabilitato";
const Dismiss = "Ignora";
const display = "visualizza";
const Display = "Visualizza";
const Documents = "Documenti";
const Donate = "Dona";
const Done = "Fatto";
const Download = "Scarica";
const edit = "Modifica";
const Edit = "Modifica";
const Email = "Email";
const Embedding = "Embedding";
const Enabled = "Abilitato";
const Enter = "Invio";
const expand = "Espandi";
const Expand = "Espandi";
const Expired = "Scaduto";
const Expires = "Scadenza";
const extension = "Estensioni";
const Failed = "Non riuscito";
const FAQs = "FAQ";
const Favorite = "Preferito";
const Feedback = "Feedback";
const Fetch = "Recupera";
const File = "File";
...
const Hide = "Nascondi";
const High = "Alto";
const History = "Cronologia";
const Homepage = "Pagina iniziale";
const Hotkeys = "Hotkeys";
const ID = "ID";
const Landscape = "Orizzontale";
const Language = "Lingua";
const Leave = "Abbandona";
const Local = "Locale";
const Login = "Accesso";
const Low = "Basso";
const Manually = "Manualmente";
const Maximize = "Massimizza";
const Medium = "Medio";
const meticulous = "Meticoloso";
const Minimize = "Minimizza";
const model = "Modello";
const Model = "Modello";
...
const name = "Nome";
const Name = "Nome";
const Natural = "Naturale";
const New = "Nuovo";
const Nickname = "Soprannome";
const No = "No";
const None = "Nessuno";
const Open = "Apri";
const Operations = "Operazioni";
const optional = "facoltativo";
const or = "o";
const Parser = "Parser";
const Pause = "Pausa";
const Pending = "In sospeso";
const Portrait = "Ritratto";
const premium = "premium";
const Preview = "Anteprima";
const Prompt = "Prompt";
const proxy = "Proxy";
const Purchase = "Acquista";
const quote = "Cita";
const Reasoning = "Ragionamento";
const Recommended = "Consigliato";
const Recover = "Recupera";
const RedNote = "Nota Rossa";
const Reference = "Riferimento";
const Refresh = "Aggiorna";
const rename = "Rinomina";
const report = "Segnala";
const Rerank = "Riclassifica";
const reset = "Ripristina";
const Reset = "Ripristina";
const Restore = "Ripristina";
...
const Settings = "Impostazioni";
const Show = "Mostra";
const Square = "Quadrato";
const Standard = "Standard";
const star = "Aggiungi ai preferiti";
const Status = "Stato";
const Stay = "Resta";
const submit = "Invia";
const Survey = "Sondaggio";
const Switch = "Cambia";
const system = "Sistema";
const temperature = "Temperatura";
const Temperature = "Temperatura";
const Terminal = "Terminale";
const Test = "Test";
const Theme = "Tema";
const Thinking = "Pensando";
const Toggle = "Attiva/Disattiva";
const token = "Token";
const tokens = "Token";
...
const unstar = "Rimuovi dai preferiti";
const Untitled = "Senza titolo";
const Upgrade = "Fai l'upgrade";
const Upload = "Carica";
const user = "Utente";
const version = "Versione";
const View = "Visualizza";
const Vision = "Visione";
const Vivid = "Vivace";
const WeChat = "WeChat";
const Yes = "Sì";
const translation = {
