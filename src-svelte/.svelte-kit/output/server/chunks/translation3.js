...
const None = "無";
const Open = "開啟";
const openai = "經典API調用方式，更好的兼容性，適用於大多數GPT模型";
const openai_classic_api_description = "經典API調用方式，更好的兼容性，適用於大多數GPT模型";
const openai_responses_api_description = "新的調用方式，專門支持chat API中不可用的gpt-5-pro和o3-pro模型，具有增強的推理能力";
const Operations = "操作";
const optional = "可選";
const or = "或";
const Parser = "解析器";
...
const quote = "引用";
const Reasoning = "推理";
const Recommended = "推薦";
const Recover = "恢復";
const RedNote = "小紅書";
const Reference = "參考";
const Refresh = "刷新";
const regenerate = "重新產生";
const rename = "改名";
const report = "舉報";
const Rerank = "重排";
const reset = "重設";
...
const Switch = "切換";
const system = "系統";
const temperature = "嚴謹與想像(Temperature)";
const Temperature = "溫度";
const Terminal = "終端機";
const Test = "測試";
const Theme = "主題";
const Thinking = "思考中";
