...
const Auto = "Automatique";
const cancel = "Annuler";
const Cancel = "Annuler";
const Capabilities = "Capacités";
const Changelog = "Journal des modifications";
const characters = "caractères";
const chat = "Discussion";
const Chat = "Chat";
const Check = "Vérifier";
const Chunk = "Segment";
const chunks = "Morceaux";
const clean = "Effacer";
const close = "Fermer";
const Close = "Fermer";
const Collapse = "Réduire";
...
const Edit = "Modifier";
const Email = "E-mail";
const Embedding = "Incorporation";
const Enabled = "Activé";
const Enter = "Entrée";
const expand = "Développer";
const Expand = "Développer";
...
const Failed = "Échec";
const FAQs = "FAQ";
const Favorite = "Favori";
const Feedback = "Commentaires";
const Fetch = "Récupérer";
const File = "Fichier";
const Format = "Format";
const Github = "Github";
const Help = "Aide";
...
const Hotkeys = "Raccourcis clavier";
const ID = "Identifiant";
const Landscape = "Paysage";
const Language = "Langue";
const Leave = "Quitter";
const Local = "Local";
const Login = "Connexion";
const Low = "Faible";
const Manually = "Manuellement";
const Maximize = "Maximiser";
const Medium = "Moyen";
const meticulous = "Méticuleux";
const Minimize = "Minimiser";
const model = "Modèle";
const Model = "Modèle";
const Models = "Modèles";
const More = "Plus";
const name = "Nom";
const Name = "Nom";
const Natural = "Plus réaliste";
const New = "Nouveau";
const Nickname = "Surnom";
const No = "Non";
const None = "Aucun";
const Open = "Ouvrir";
const Operations = "Opérations";
const optional = "facultatif";
const or = "ou";
const Parser = 'THOUGHT: The user wants to translate the word "Parser" from English to French. This is a technical term used in the context of software and data processing.\n\nThe most direct and commonly used translation for "parser" in French, especially in a technical context, is "analyseur".Analyseur';
const Pause = "Pause";
...
const Prompt = "Invite";
const proxy = "Proxy";
const Purchase = "Acheter";
const quote = "Citer";
const Reasoning = "Raisonnement";
const Recommended = "Recommandé";
const Recover = "Récupérer";
const RedNote = "RedNote";
const Reference = "Référence";
const Refresh = "Actualiser";
const regenerate = "Régénérer";
const rename = "Renommer";
const report = "Signaler";
const Rerank = "Reclasser";
const reset = "Réinitialiser";
const Reset = "Réinitialiser";
const Restore = "Restaurer";
const Result = "Résultat";
const Resume = "Reprendre";
const Retry = `Pensez étape par étape.
...
const Roadmap = "Feuille de route";
...
const Survey = "Enquête";
const Switch = "Changer";
const system = "Système";
const temperature = "Température";
const Temperature = "Température";
const Terminal = "Terminal";
const Test = "Test";
const Theme = "Thème";
const Thinking = "Réflexion";
const Toggle = "Basculer";
const token = "Jeton";
const tokens = "Jetons";
const Tokens = "Jetons";
const Tools = "Outils";
...
const unstar = "Retirer l'étoile";
const Untitled = "Sans titre";
const Upgrade = "Mettre à niveau";
const Upload = "Téléverser";
const user = "Utilisateur";
const version = "Version";
const View = "Voir";
const Vision = "Vision";
const Vivid = "Plus artistique";
const WeChat = "WeChat";
const Yes = "Oui";
const translation = {
