...
const None = "None";
const Open = "Open";
const openai = "Classic API calling method, better compatibility, suitable for most GPT models";
const openai_classic_api_description = "Classic API calling method, better compatibility, suitable for most GPT models";
const openai_responses_api_description = "New calling method, exclusively supports gpt-5-pro and o3-pro models not available in chat API, with enhanced reasoning capabilities";
...
const translation = {
  ...
  openai_classic_api_description,
  openai_responses_api_description,
