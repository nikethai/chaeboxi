...
- **Project folders** — desktop Projects can bind one user-picked directory; generic project shell is unavailable. File tools stage changes for review instead of writing immediately.
