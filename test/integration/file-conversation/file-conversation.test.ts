...
describe('File Conversation Integration Tests', () => {
  ...
  async function runConversationTest(
    ...
    const systemPrompt = options?.noSystemPrompt ? undefined : (options?.systemPrompt ?? DEFAULT_SYSTEM_PROMPT)
  ...
  describe('Single File Tests', () => {
    it.skipIf(shouldSkip)(
      'should read plain text file and answer questions',
      async () => {
    ...
    it.skipIf(shouldSkip)(
      'should read TypeScript file and explain code',
      async () => {
    ...
    it.skipIf(shouldSkip)(
      'should read JSON file and extract data',
      async () => {
  ...
  describe('Search File Content Tests', () => {
    it.skipIf(shouldSkip)(
      'should use search_file_content to search for specific content',
      async () => {
  ...
  describe('Multi-File Tests', () => {
    it.skipIf(shouldSkip)(
      'should handle multiple files in one conversation',
      async () => {
        const textFile = loadTestFile('sample.txt')
        const jsonFile = loadTestFile('sample.json', 'application/json')
  ...
  describe('Multi-Turn Conversation Tests', () => {
    it.skipIf(shouldSkip)(
      'should answer follow-up questions about the same file',
      async () => {
        const tsFile = loadTestFile('sample.ts', 'text/typescript')
...
When asked about file content, structure your response as:
{
  ...
  "context": "surrounding context"
    ...
    it.skipIf(shouldSkip)(
      'should follow persona in system prompt',
      async () => {
        const textFile = loadTestFile('sample.txt')
