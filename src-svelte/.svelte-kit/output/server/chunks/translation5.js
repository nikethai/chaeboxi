...
const All = "모두";
const Arguments = "인수";
const assistant = "어시스턴트";
const Auto = "자동";
const cancel = "취소";
const Cancel = "취소";
const Capabilities = "기능";
const Changelog = "변경 내역";
const characters = "글자";
const chat = "채팅";
const Chat = "채팅";
const Check = "확인";
