...
const Advanced = "Avançado";
const All = "Todos";
const Arguments = "Argumentos";
const assistant = "Assistente";
const Auto = "Automático";
const cancel = "Cancelar";
const Cancel = "Cancelar";
const Capabilities = "Capacidades";
const Changelog = "Registro de alterações";
const characters = "Caracteres";
const chat = "Conversa";
const Chat = "Conversa";
const Check = "Verificar";
const Chunk = "Fragmento";
const chunks = "Blocos";
const clean = "Limpar";
const close = "Fechar";
const Close = "Fechar";
...
const Disabled = "Desabilitado";
const Dismiss = "Descartar";
const display = "Exibir";
const Display = "Exibir";
const Documents = "Documentos";
const Donate = "Doar";
const Done = "Concluído";
const Download = "Descarregar";
const edit = "Editar";
const Edit = "Editar";
const Email = "Email";
const Embedding = "Incorporação";
const Enabled = "Ativado";
const Enter = "Tecla Enter";
const expand = "Expandir";
const Expand = "Expandir";
const Expired = "Expirado";
const Expires = "Expira";
const extension = "Extensões";
const Failed = "Falhou";
const FAQs = "FAQs";
...
const Hotkeys = "Atalhos de teclado";
const ID = "ID";
const Landscape = "Paisagem";
const Language = "Língua";
const Leave = "Sair";
const Local = "Local";
const Login = "Iniciar Sessão";
const Low = "Baixo";
const Manually = "Manualmente";
const Maximize = "Maximizar";
const Medium = "Médio";
const meticulous = "Meticuloso";
const Minimize = "Minimizar";
const model = "Modelo";
const Model = "Modelo";
...
const None = "Nenhum";
const Open = "Abrir";
const Operations = "Operações";
const optional = "Opcional";
const or = "ou";
const Parser = "Analisador";
const Pause = "Pausa";
const Pending = "Pendente";
const Portrait = "Retrato";
const premium = "Edição Premium";
const Preview = "Pré-visualizar";
const Prompt = "Prompt";
const proxy = "Proxy";
const Purchase = "Comprar";
const quote = "Citar";
const Reasoning = "Raciocínio";
const Recommended = "Recomendado";
const Recover = "Recuperar";
const RedNote = "Nota Vermelha";
const Reference = "Referência";
const Refresh = "Atualizar";
const regenerate = "Regenerar";
const rename = "Renomear";
const report = "Reportar";
const Rerank = "Reordenar";
const reset = "Repor";
const Reset = "Repor";
const Restore = "Restaurar";
const Result = "Resultado";
const Resume = "Retomar";
const Retry = "Tentar Novamente";
const Roadmap = "Roteiro";
const save = "Guardar";
const Save = "Salvar";
const Scope = "Âmbito";
...
const send = "Enviar";
const Send = "Enviar";
const settings = "definições";
const Settings = "Definições";
const Show = "Mostrar";
const Square = "Quadrado";
const Standard = "Padrão";
const star = "Favoritar";
const Status = "Estado";
const Stay = "Ficar";
const submit = "Enviar";
const Survey = "Pesquisa";
const Switch = "Mudar";
const system = "Sistema";
const temperature = "Temperatura (Rigor e Imaginação)";
const Temperature = "Temperatura";
const Terminal = "Terminal";
const Test = "Teste";
const Theme = "Tema";
const Thinking = "A pensar";
const Toggle = "Alternar";
const token = "Token";
const tokens = "Tokens";
const Tokens = "Tokens";
...
const unstar = "Desfavoritar";
const Untitled = "Sem Título";
const Upgrade = "Atualizar";
const Upload = "Carregar";
