...
const Action = "Åtgärd";
const Add = "Lägg till";
const advanced = "Avancerat";
const Advanced = "Avancerad";
const All = "Alla";
const Arguments = "Argument";
const assistant = "Assistent";
const Auto = "Automatisk";
const cancel = "Avbryt";
const Cancel = "Avbryt";
const Capabilities = "Funktioner";
const Changelog = "Ändringslogg";
const characters = "tecken";
const chat = "Chatt";
const Chat = "Chatt";
const Check = "Kontrollera";
const Chunk = "Segment";
const chunks = "Segment";
const clean = "Rensa";
const close = "Stäng";
const Close = "Stäng";
const Collapse = "Minimera";
const Command = "Kommando";
const Completed = "Slutförd";
const Confirm = "Bekräfta";
const Connected = "Ansluten";
const Content = "Innehåll";
const Context = "Kontext";
const Copied = "Kopierat";
const copy = "Kopiera";
const Copy = "Kopiera";
const Cost = "Kostnad";
const Create = "Skapa";
const creative = "Kreativ";
const Custom = "Anpassad";
const Deactivate = "Inaktivera";
const Delete = "Radera";
const Description = "Beskrivning";
const Details = "Detaljer";
const Disabled = "Inaktiverad";
const Dismiss = "Avvisa";
const display = "visa";
const Display = "Visa";
const Documents = "Dokument";
const Donate = "Donera";
const Done = "Klar";
...
const Edit = "Redigera";
const Email = "E-post";
const Embedding = "Inbäddning";
const Enabled = "Aktiverad";
const Enter = "Enter";
const expand = "Expandera";
const Expand = "Expandera";
const Expired = "Utgången";
const Expires = "Utgår";
const extension = "Tillägg";
const Failed = "Misslyckades";
const FAQs = "Vanliga frågor";
const Favorite = "Favorit";
const Feedback = "Återkoppling";
const Fetch = "Hämta";
const File = "Fil";
const Format = "Format";
const Github = "Github";
...
const Hotkeys = "Snabbknappar";
const ID = "ID";
const Landscape = "Liggande";
const Language = "Språk";
const Leave = "Lämna";
const Local = "Lokal";
const Login = "Logga in";
const Low = "Låg";
const Manually = "Manuellt";
const Maximize = "Maximera";
const Medium = "Medel";
const meticulous = "Noggrann";
const Minimize = "Minimera";
const model = "Modell";
const Model = "Modell";
const Models = "Modeller";
const More = "Mer";
const name = "Namn";
const Name = "Namn";
const Natural = "Naturlig";
const New = "Ny";
const Nickname = "Visningsnamn";
const No = "Nej";
const None = "Inget";
const Open = "Öppna";
const Operations = "Åtgärder";
const optional = "Valfritt";
const or = "eller";
const Parser = "Parser";
const Pause = "Pausa";
const Pending = "Väntande";
const Portrait = "Porträtt";
const premium = "premium";
const Preview = "Förhandsgranska";
const Prompt = "Instruktion";
const proxy = "Proxy";
const Purchase = "Köp";
const quote = "Citat";
const Reasoning = "Resonemang";
const Recommended = "Rekommenderas";
const Recover = "Återställ";
const RedNote = "Rödanteckning";
const Reference = "Referens";
const Refresh = "Uppdatera";
const rename = "Byt namn";
const report = "Rapportera";
const Rerank = "Omranka";
const reset = "Återställ";
const Reset = "Återställ";
const Restore = "Återställ";
const Result = "Resultat";
const Resume = "Återuppta";
const Retry = 'Tänk steg för steg. Jag är en professionell översättare för UI. Jag ska översätta texten "Retry" till svenska.\n\n1. **Analysera ordet:** "Retry" betyder att försöka igen.\n2. **Kontext:** I ett UI är det ofta en knapp eller en länk som användaren klickar på för att upprepa en misslyckad åtgärd.\n3. **Svenska motsvarigheter:**\n    * "Försök igen" - Mycket vanligt och direkt.\n    * "Återförsök" - Mer formellt, men också korrekt.\n    * "Prova igen" - Lite mer informellt, men också gångbart.\n4. **UI-standarder:** "Försök igen" är den mest etablerade och intuitiva översättningen för "Retry" i svenska användargränssnitt. Den är kort, tydlig och lätt att förstå.\n\n**Slutgiltigt val:** "Försök igen"\n\nFörsök igen';
const Roadmap = "Utvecklingsplan";
const save = "Spara";
const Save = "Spara";
const Scope = "Omfattning";
const Search = "Sök";
const send = "Skicka";
const Send = "Skicka";
...
const Settings = "Inställningar";
const Show = "Visa";
const Square = "Kvadratisk";
const Standard = "Standard";
const star = "Stjärnmärk";
const Status = "Status";
const Stay = "Stanna kvar";
const submit = "Skicka";
const Survey = "Undersökning";
const Switch = "Byt";
const system = "System";
...
const Type = "Skriv";
const Unknown = "Okänd";
const Unmaximize = "Återställ";
const unstar = "Ta bort stjärnmärkning";
const Untitled = "Namnlös";
const Upgrade = "Uppgradera";
const Upload = "Ladda upp";
const user = "Användare";
