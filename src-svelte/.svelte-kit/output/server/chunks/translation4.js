...
const All = "すべて";
const Arguments = "引数";
const assistant = "アシスタント";
const Auto = "自動";
const cancel = "キャンセル";
const Cancel = "キャンセル";
const Capabilities = "機能";
const Changelog = "変更履歴";
const characters = "文字数";
const chat = "チャット";
const Chat = "チャット";
const Check = "チェック";
const Chunk = "チャンク";
...
const close = "閉じる";
const Close = "閉じる";
const Collapse = "折りたたむ";
const Command = "コマンド";
const Completed = "完了";
const Confirm = "確認";
const Connected = "接続済み";
const Content = "コンテンツ";
const Context = "コンテキスト";
const Copied = "コピーしました";
const copy = "コピー";
const Copy = "コピー";
const Cost = "コスト";
const Create = "作成";
const creative = "クリエイティブ";
const Custom = "カスタム";
const Deactivate = "無効化する";
const Delete = "削除";
...
const display = "表示";
const Display = "表示";
const Documents = "ドキュメント";
const Donate = "寄付する";
const Done = "完了";
const Download = "ダウンロード";
const edit = "編集";
const Edit = "編集";
const Email = "メール";
const Embedding = "埋め込み";
const Enabled = "有効";
const Enter = "エンター";
const expand = "展開";
const Expand = "展開";
...
const High = "高";
const History = "履歴";
const Homepage = "ホームページ";
const Hotkeys = "ショートカットキー";
const ID = "ID";
const Landscape = "横長";
const Language = "言語";
const Leave = "離れる";
...
const quote = "引用";
const Reasoning = "推論";
const Recommended = "推奨";
const Recover = "復元";
const RedNote = "レッドノート";
const Reference = "参照";
const Refresh = "リフレッシュ";
const regenerate = "再生成";
const rename = "名前を変更";
const report = "報告";
const Rerank = "再ランキング";
const reset = "リセット";
...
const View = "表示";
const Vision = "ビジョン";
const Vivid = "よりアーティスティック";
const WeChat = "WeChat (ウィーチャット)";
const Yes = "はい";
const translation = {
  " for free now!": " 今すぐ無料で！",
  "(Trial)": "（トライアル）",
