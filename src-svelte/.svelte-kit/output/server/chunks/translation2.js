...
const None = "无";
const Open = "打开";
const openai = "经典API调用方式，更好的兼容性，适用于大多数GPT模型";
const openai_classic_api_description = "经典API调用方式，更好的兼容性，适用于大多数GPT模型";
const openai_responses_api_description = "新的调用方式，专门支持chat API中不可用的gpt-5-pro和o3-pro模型，具有增强的推理能力";
const Operations = "操作";
const optional = "可选";
const or = "或";
const Parser = "解析器";
...
const Switch = "切换";
const system = "系统";
const temperature = "严谨与想象(Temperature)";
