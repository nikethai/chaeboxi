...
const Advanced = "Erweitert";
const All = "Alle";
const Arguments = "Argumente";
const assistant = "Assistent";
const Auto = "Auto";
const cancel = "Abbrechen";
const Cancel = "Abbrechen";
const Capabilities = "Fähigkeiten";
const Changelog = "Änderungsprotokoll";
const characters = "Zeichen";
const chat = "Chat";
const Chat = "Chat";
const Check = "Überprüfen";
const Chunk = "Block";
const chunks = "Blöcke";
const clean = "Löschen";
const close = "Schließen";
const Close = "Schließen";
const Collapse = "Reduzieren";
const Command = "Befehl";
const Completed = "Abgeschlossen";
const Confirm = "Bestätigen";
const Connected = "Verbunden";
...
const Disabled = "Deaktiviert";
const Dismiss = "Schließen";
const display = "Anzeige";
const Display = "Anzeigen";
const Documents = "Dokumente";
const Donate = "Spenden";
const Done = "Fertig";
const Download = "Herunterladen";
const edit = "Bearbeiten";
const Edit = "Bearbeiten";
const Email = "E-Mail";
const Embedding = "Embedding";
const Enabled = "Aktiviert";
const Enter = "Eingabe";
const expand = "Erweitern";
const Expand = "Erweitern";
const Expired = "Abgelaufen";
const Expires = "Ablauf";
const extension = "Erweiterungen";
...
const Github = "Github";
const Help = "Hilfe";
const Hide = "Ausblenden";
const High = "Hoch";
const History = "Verlauf";
const Homepage = "Startseite";
const Hotkeys = "Tastenkürzel";
const ID = "ID";
const Landscape = "Querformat";
const Language = "Sprache";
const Leave = "Verlassen";
const Local = "Lokal";
const Login = "Anmelden";
const Low = "Niedrig";
const Manually = "Manuell";
const Maximize = "Maximieren";
const Medium = "Mittel";
const meticulous = "Gründlich";
const Minimize = "Minimieren";
const model = "Modell";
const Model = "Modell";
const Models = "Modelle";
const More = "Mehr";
const name = "Name";
const Name = "Name";
const Natural = "realistisch";
const New = "Neu";
const Nickname = "Benutzername";
const No = "Nein";
const None = "Keine";
const Open = "Öffnen";
const Operations = "Operationen";
const optional = "Optional";
const or = "oder";
const Parser = "Parser";
const Pause = "Pause";
const Pending = "Ausstehend";
const Portrait = "Hochformat";
const premium = "Premium";
const Preview = "Vorschau";
const Prompt = "Eingabeaufforderung";
const proxy = "Proxy";
const Purchase = "Kaufen";
const quote = "Zitieren";
const Reasoning = "Schlussfolgerung";
const Recommended = "Empfohlen";
const Recover = "Wiederherstellen";
const RedNote = "Rotnotiz";
const Reference = "Referenz";
const Refresh = "Aktualisieren";
const regenerate = "Neu generieren";
const rename = "Umbenennen";
const report = "Melden";
const Rerank = "Neu ordnen";
const reset = "Zurücksetzen";
const Reset = "Zurücksetzen";
const Restore = "Wiederherstellen";
const Result = "Ergebnis";
const Resume = "Fortsetzen";
const Retry = "Zurückversuchen";
...
const Settings = "Einstellungen";
const Show = "Anzeigen";
const Square = "Quadratisch";
const Standard = "Standard";
const star = "Favorit";
const Status = "Status";
const Stay = "Bleiben";
const submit = "Senden";
const Survey = "Umfrage";
const Switch = "Wechseln";
const system = "System";
...
const unstar = "Entfernen aus Favoriten";
