...
const Add = "Добавить";
const advanced = "Расширенные";
const Advanced = "Расширенный";
const All = "Все";
const Arguments = "Аргументы";
const assistant = "Ассистент";
const Auto = "Авто";
const cancel = "Отмена";
const Cancel = "Отмена";
const Capabilities = "Возможности";
const Changelog = "Список изменений";
const characters = "символы";
const chat = "Чат";
const Chat = "Чат";
const Check = "Проверить";
const Chunk = "Фрагмент";
const chunks = "фрагменты";
const clean = "Очистить";
const close = "Закрыть";
const Close = "Закрыть";
...
const Connected = "Подключено";
const Content = "Содержимое";
const Context = "Контекст";
const Copied = "Скопировано";
const copy = "Копировать";
const Copy = "Копировать";
const Cost = "Стоимость";
const Create = "Создать";
const creative = "Творческий";
const Custom = "Пользовательский";
const Deactivate = "Деактивировать";
const Delete = "Удалить";
const Description = "Описание";
const Details = "Детали";
const Disabled = "Отключено";
const Dismiss = "Отклонить";
const display = "дисплей";
const Display = "Отображение";
const Documents = "Документы";
const Donate = "Пожертвовать";
const Done = "Готово";
const Download = "Скачать";
const edit = "Редактировать";
const Edit = "Редактировать";
const Email = "Электронная почта";
const Embedding = "Векторное представление";
const Enabled = "Включен";
const Enter = "Ввод";
const expand = "Развернуть";
const Expand = "Развернуть";
const Expired = "Истек";
const Expires = "Истекает";
const extension = "Расширения";
const Failed = "Не удалось";
const FAQs = "Часто задаваемые вопросы";
const Favorite = "Избранное";
...
const Homepage = "Домашняя страница";
const Hotkeys = "Горячие клавиши";
const ID = "Идентификатор";
const Landscape = "Альбомная";
const Language = "Язык";
const Leave = "Покинуть";
const Local = "Локальный";
const Login = "Войти";
const Low = "Низкий";
const Manually = "Вручную";
const Maximize = "Максимизировать";
const Medium = "Средний";
const meticulous = "Тщательный";
const Minimize = "Минимизировать";
const model = "Модель";
const Model = "Модель";
const Models = "Модели";
const More = "Больше";
const name = "Имя";
const Name = "Название";
const Natural = "более реалистичный";
const New = "Новый";
const Nickname = "Псевдоним";
const No = "Нет";
const None = "Нет";
const Open = "Открыть";
const Operations = "Операции";
const optional = "необязательный";
const or = "или";
const Parser = "Парсер";
const Pause = "Пауза";
const Pending = "Ожидание";
const Portrait = "Портрет";
const premium = "премиум";
const Preview = "Предпросмотр";
const Prompt = "Подсказка";
const proxy = "Прокси";
const Purchase = "Купить";
const quote = "Цитировать";
const Reasoning = "Логика";
const Recommended = "Рекомендовано";
const Recover = "Восстановить";
const RedNote = "Красная Заметка";
const Reference = "Ссылка";
const Refresh = "Обновить";
const regenerate = "Перегенерировать";
const rename = "Переименовать";
const report = "Отправить жалобу";
const Rerank = "Переранжировать";
const reset = "Сбросить";
const Reset = "Сброс";
const Restore = "Восстановить";
const Result = "Результат";
const Resume = "Продолжить";
const Retry = "Повторить";
const Roadmap = "План развития";
...
const Settings = "Настройки";
const Show = "Показать";
const Square = "Квадрат";
const Standard = "Стандартный";
const star = "Добавить в избранное";
const Status = "Статус";
const Stay = "Остаться";
const submit = "Отправить";
const Survey = "Опрос";
const Switch = "Переключить";
...
const Test = "Тест";
const Theme = "Тема";
const Thinking = "Думаю";
const Toggle = "Переключение";
const token = "Токен";
const tokens = "токены";
const Tokens = "Токены";
...
const unstar = "Удалить из избранного";
const Untitled = "Без названия";
const Upgrade = "Обновить";
const Upload = "Загрузить";
const user = "Пользователь";
const version = "Версия";
const View = "Просмотр";
const Vision = "Видение";
const Vivid = "более художественный";
const WeChat = "WeChat";
const Yes = "Да";
const translation = {
