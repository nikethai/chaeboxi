...
declare module '$env/static/private' {
	...
	export const KAKU_CONFIG_DIR: string;
	...
	export const KAKU_CONFIG_FILE: string;
	...
	export const KAKU_ZSH_DIR: string;
