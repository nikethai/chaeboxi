...
const Action = "العمل";
const Add = "إضافة";
const advanced = "متقدم";
const Advanced = "متقدم";
const All = "الكل";
const Arguments = "حجج";
const assistant = "المساعد";
const Auto = "تلقائي";
const cancel = "إلغاء";
const Cancel = "إلغاء";
const Capabilities = "القدرات";
const Changelog = "سجل التغييرات";
...
const Collapse = "طي";
const Command = "أمر";
const Completed = "اكتمل";
const Confirm = "تأكيد";
const Connected = "متصل";
const Content = "المحتوى";
const Context = "السياق";
const Copied = "تم النسخ";
const copy = "نسخ";
const Copy = "نسخ";
const Cost = "التكلفة";
const Create = "إنشاء";
const creative = "إبداعي";
const Custom = "مخصص";
const Deactivate = "إلغاء التفعيل";
const Delete = "حذف";
...
const Edit = "تعديل";
const Email = "Email";
const Embedding = "تضمين";
const Enabled = "مفعل";
const Enter = "إدخال";
const expand = "توسيع";
const Expand = "توسيع";
const Expired = "منتهي الصلاحية";
const Expires = "انتهاء الصلاحية";
const extension = "الإضافات";
const Failed = "فشل";
const FAQs = "الأسئلة الشائعة";
const Favorite = "المفضلة";
const Feedback = "التغذية الراجعة";
const Fetch = "استرداد";
const File = "ملف";
const Format = "التنسيق";
const Github = "Github";
const Help = "مساعدة";
const Hide = "إخفاء";
const High = "مرتفع";
...
const Hotkeys = "مفاتيح السرعة";
const ID = "المعرف";
const Landscape = "أفقي";
const Language = "اللغة";
const Leave = "مغادرة";
const Local = "محلي";
const Login = "سجل الدخول";
const Low = "منخفض";
const Manually = "يدويًا";
const Maximize = "تكبير";
const Medium = "متوسط";
const meticulous = "دقيق";
const Minimize = "تصغير";
const model = "النموذج";
const Model = "نموذج";
const Models = "نماذج";
const More = "المزيد";
...
const Natural = "طبيعي";
const New = "جديد";
const Nickname = "الاسم المستعار";
const No = "لا";
const None = "لا شيء";
const Open = "فتح";
const Operations = "العمليات";
const optional = "اختياري";
const or = "أو";
const Parser = "محلل";
const Pause = "إيقاف مؤقت";
const Pending = "معلق";
const Portrait = "رأسي";
const premium = "المميز";
const Preview = "معاينة";
const Prompt = "التوجيه";
const proxy = "الوكيل";
const Purchase = "شراء";
const quote = "اقتباس";
const Reasoning = "الاستدلال";
const Recommended = "موصى به";
const Recover = "استعادة";
const RedNote = "ملاحظة حمراء";
const Reference = "مرجع";
const Refresh = "تحديث";
const rename = "إعادة تسمية";
const report = "الإبلاغ";
const Rerank = "إعادة الترتيب";
const reset = "إعادة تعيين";
const Reset = "إعادة تعيين";
const Restore = "استعادة";
const Result = "نتيجة";
const Resume = "استئناف";
const Retry = "إعادة المحاولة";
const Roadmap = "خارطة الطريق";
const save = "حفظ";
const Save = "حفظ";
const Scope = "النطاق";
const Search = "بحث";
...
const Show = "عرض";
const Square = "مربع";
const Standard = "قياسي";
const star = "نجمة";
const Status = "الحالة";
const Stay = "البقاء";
const submit = "إرسال";
const Survey = "استطلاع";
const Switch = "تبديل";
const system = "النظام";
const temperature = "درجة الحرارة";
const Temperature = "درجة الحرارة";
const Terminal = "طرفية";
const Test = "اختبار";
const Theme = "المظهر";
const Thinking = "جاري التفكير";
const Toggle = "تبديل";
const token = "token";
const tokens = "tokens";
const Tokens = "Tokens";
...
const unstar = "إزالة النجمة";
const Untitled = "بلا عنوان";
const Upgrade = "ترقية";
const Upload = "رفع";
const user = "المستخدم";
