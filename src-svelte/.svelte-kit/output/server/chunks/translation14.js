...
const Action = "Åtgärd";
const Add = "Legg til";
const advanced = "Avansert";
const Advanced = "Avansert";
const All = "Alle";
const Arguments = "Argumenter";
const assistant = "Assistent";
const Auto = "Auto";
const cancel = "Avbryt";
const Cancel = "Avbryt";
const Capabilities = "Ferdigheter";
const Changelog = "Endringslogg";
const characters = "tegn";
const chat = "Chat";
const Chat = "Chat";
const Check = "Sjekk";
const Chunk = "Del";
const chunks = "biter";
const clean = "Rydd opp";
const close = "Lukk";
const Close = "Lukk";
const Collapse = "Skjul";
const Command = "Kommando";
const Completed = "Fullført";
const Confirm = "Bekreft";
const Connected = "Tilkoblet";
const Content = "Innhold";
const Context = "Kontekst";
const Copied = "Kopiert";
const copy = "Kopier";
const Copy = "Kopier";
const Cost = "Kostnad";
const Create = "Opprett";
const creative = "Kreativ";
const Custom = "Tilpasset";
const Deactivate = "Deaktiver";
const Delete = "Slett";
const Description = "Beskrivelse";
const Details = "Detaljer";
const Disabled = "Deaktivert";
const Dismiss = "Avvis";
const display = "visning";
const Display = "Vis";
const Documents = "Dokumenter";
const Donate = "Doner";
const Done = "Ferdig";
...
const Edit = "Rediger";
const Email = "E-post";
const Embedding = "Innebygging";
const Enabled = "Aktiver";
const Enter = "Enter";
const expand = "Utvid";
const Expand = "Utvid";
const Expired = "Utløpt";
const Expires = "Utløper";
const extension = "Utvidelser";
const Failed = "Mislyktes";
const FAQs = "Ofte stilte spørsmål";
const Favorite = "Favoritt";
const Feedback = "Tilbakemelding";
const Fetch = "Hent";
const File = "Fil";
const Format = "Format";
const Github = "Github";
...
const Hide = "Skjul";
const High = "Høy";
const History = "Historikk";
const Homepage = "Hjemmeside";
const Hotkeys = "Snabbknappar";
const ID = "ID";
const Landscape = "Liggende";
const Language = "Språk";
const Leave = "Forlat";
const Local = "Lokal";
const Login = "Logg inn";
const Low = "Lav";
const Manually = "Manuelt";
const Maximize = "Maksimer";
const Medium = "Middels";
const meticulous = "Nøyaktig";
const Minimize = "Minimer";
const model = "Modell";
const Model = "Modell";
...
const Parser = "Parser";
const Pause = "Pause";
const Pending = "Ventende";
const Portrait = "Portrett";
const premium = "premium";
const Preview = "Forhåndsvis";
const Prompt = "Ledetekst";
const proxy = "Mellomtjener";
const Purchase = "Kjøp";
const quote = "Siter";
const Reasoning = "Resonnement";
const Recommended = "Anbefalt";
const Recover = "Gjenopprett";
const RedNote = "Rødnotat";
const Reference = "Referanse";
const Refresh = "Oppdater";
const rename = "Gi nytt navn";
const report = "Rapporter";
const Rerank = "Omranger";
const reset = "Tilbakestill";
const Reset = "Tilbakestill";
const Restore = "Gjenopprett";
const Result = "Resultat";
const Resume = "Gjenoppta";
const Retry = "Prøv på nytt";
const Roadmap = "Veikart";
const save = "Lagre";
const Save = "Lagre";
const Scope = "Omfang";
const Search = "Søk";
...
const star = "Merk som favoritt";
const Status = "Status";
const Stay = "Bli";
const submit = "Send inn";
const Survey = "Undersøkelse";
const Switch = "Bytt";
const system = "System";
...
const unstar = "Fjern fra favoritter";
const Untitled = "Uten tittel";
const Upgrade = "Oppgrader";
const Upload = "Last opp";
const user = "Bruker";
const version = "Versjon";
const View = "Vis";
const Vision = "Syn";
const Vivid = "Livlig";
const WeChat = "WeChat";
